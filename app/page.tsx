      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .button:hover {
          ...
          box-shadow: 0 10px 22px rgba(255,237,115,0.28);
        }
      ...
      <div className="content">
        ...
        >
          ...
          >
            ...
            <h2 style={{ fontSize: "34px", marginBottom: "18px", fontWeight: 900 }}>
              Déposer une offre
            </h2>

            <p style={{ lineHeight: "1.5", color: "#e8e8e8", minHeight: "70px" }}>
        ...
        >
          {[
            ["23", "écoles", "#ffed73"],
            ["+21 000", "étudiants", "#b7e4ff"],
            ["10 000", "entreprises d’accueil", "#f3c7b0"],
            ["43 000", "alumni en activité", "#a7e8c5"],
          ].map(([nombre, label, couleur], index) => (
            <div
              key={label}
            ...
            >
              <h2 style={{ fontSize: "42px", margin: "0 0 16px", fontWeight: 900 }}>
                {nombre}
              </h2>

              <p style={{ margin: 0, fontSize: "17px", color: "#e8e8e8" }}>
                {label}
              </p>
            </div>
          ))}
